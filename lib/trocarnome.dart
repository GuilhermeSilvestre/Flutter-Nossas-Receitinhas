...
class TrocarNome extends StatefulWidget {
  const TrocarNome({Key? key}) : super(key: key);

  @override
  State<TrocarNome> createState() => _TrocarNomeState();
}

class _TrocarNomeState extends State<TrocarNome> {
  String novoNome = '';
